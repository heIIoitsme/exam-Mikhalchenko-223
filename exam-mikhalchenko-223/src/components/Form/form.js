...
const MainForm = () => {
  ...
  const handleDateOfBirthChange = (value) => {
    ...
    if (value.trim() === '') {
        setDateOfBirthError('Проверьте правильность даты');
      return; // Добавлен return, чтобы прервать выполнение функции
    }
    const validationResult = validateDateOfBirth(value);
    setDateOfBirthError(validationResult.errorMessage); // Установка сообщения об ошибке в зависимости от результата валидации
  };
